SELECT
    ...
    ROUND((SUM(saeb."notaMatematica" * ia."qtdAlunosInse") / NULLIF(SUM(ia."qtdAlunosInse"), 0))::numeric, 2) AS media_pond_matematica,
    ROUND((SUM(saeb."notaLinguaPort" * ia."qtdAlunosInse") / NULLIF(SUM(ia."qtdAlunosInse"), 0))::numeric, 2) AS media_pond_portugues,
...
-- CORRIGIR A PORRA TODA DE CALCULAR O NIVEL SOCIOECONOMICO