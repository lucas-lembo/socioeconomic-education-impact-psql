...
The output generated by executing the queries are saved as CSV files in the `/sql_outputs` directory:

*   [`query_1_output.csv`](./sql_outputs/query_1_output.csv)
*   [`query_2_output.csv`](./sql_outputs/query_2_output.csv)
*   [`query_3_output.csv`](./sql_outputs/query_3_output.csv)
*   [`query_4_output.csv`](./sql_outputs/query_4_output.csv)
*   [`query_5_output.csv`](./sql_outputs/query_5_output.csv)
